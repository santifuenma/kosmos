...
export function BrainIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a8 8 0 0 1 8 8c0 3-1.5 5.5-3 7v3a2 2 0 0 1-2 2h-6a2 2 0 0 1-2-2v-3c-1.5-1.5-3-4-3-7a8 8 0 0 1 8-8z" />
      <line x1="10" y1="22" x2="10" y2="20" />
...
export function EyeOffIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a20.3 20.3 0 0 1 4.22-5.94M9.9 4.24A9.7 9.7 0 0 1 12 4c7 0 11 8 11 8a20.36 20.36 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" />
...
/* Carita SVG para cada estado emocional */
export function EmotionFaceIcon({ state, className }: { state: string; className?: string }) {
  const svg = {
    width: 20, height: 20,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  if (state === 'ANXIOUS') return (
    <svg {...svg}>
      <circle cx="12" cy="12" r="9" />
      <circle cx="9" cy="10" r="1" fill="currentColor" stroke="none" />
      <circle cx="15" cy="10" r="1" fill="currentColor" stroke="none" />
      <path d="M8.5 15.5 Q10 13 12 15.5 Q14 18 15.5 15.5" />
    </svg>
  )
  if (state === 'FRUSTRATED') return (
    <svg {...svg}>
      <circle cx="12" cy="12" r="9" />
      <circle cx="9" cy="10" r="1" fill="currentColor" stroke="none" />
      <circle cx="15" cy="10" r="1" fill="currentColor" stroke="none" />
      <path d="M8 16 Q12 12.5 16 16" />
    </svg>
  )
  if (state === 'TIRED') return (
    <svg {...svg}>
      <circle cx="12" cy="12" r="9" />
